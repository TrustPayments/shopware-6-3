...
class TransactionController extends AbstractController {
	 ...
	 * @Route(
	 *     "/api/v{version}/_action/trustpayments/transaction/get-transaction-data/",
	 *     name="api.action.trustpayments.transaction.get-transaction-data",
	 *     methods={"POST"}
	 *     )
	 */
	 ...
	 *
	 * @Route(
	 *     "/api/v{version}/_action/trustpayments/transaction/get-invoice-document/{salesChannelId}/{transactionId}",
	 *     name="api.action.trustpayments.transaction.get-invoice-document",
	 *     methods={"GET"},
	 ...
	 *
	 * @Route(
	 *     "/api/v{version}/_action/trustpayments/transaction/get-packing-slip/{salesChannelId}/{transactionId}",
	 *     name="api.action.trustpayments.transaction.get-packing-slip",
	 *     methods={"GET"},
	 *     defaults={"csrf_protected"=false, "auth_required"=false}
	 *     )
	 */
