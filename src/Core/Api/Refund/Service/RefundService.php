...
namespace TrustPaymentsPayment\Core\Api\Refund\Service;
 ...
 * Class RefundService
 *
 * @package TrustPaymentsPayment\Core\Api\Refund\Service
 */
class RefundService {
	 ...
	 *
	 * @return \TrustPayments\Sdk\Model\Refund|null
	 * @throws \Exception
	 */
	...
	public function upsert(Refund $refund, Context $context): void
	{
		...
		try {
			...
			$this->container->get('trustpayments_refund.repository')->upsert([$data], $context);
	...
	/**
	 * Get refund entity by TrustPayments refund id
	 *
	 * @param int                              $refundId
	 * @param \Shopware\Core\Framework\Context $context
	 *
	 * @return \TrustPaymentsPayment\Core\Api\Refund\Entity\RefundEntity|null
	 */
	public function getByRefundId(int $refundId, Context $context): ?RefundEntity
	{
		return $this->container->get('trustpayments_refund.repository')
							   ->search(
