...
namespace TrustPaymentsPayment\Core\Api\WebHooks\Service;
 ...
 *
 * @package TrustPaymentsPayment\Core\Api\WebHooks\Service
 */
class WebHooksService {
	...
	protected $webHookEntityArrayConfig = [
		 ...
		 *
		 * @link https://www.trustpayments.com//doc/api/webhook-entity/view/1472041829003
		 */
		[
			'id'                => '1472041829003',
		 ...
		 *
		 * @link https://www.trustpayments.com//doc/api/webhook-entity/view/1472041816898
		 */
		[
			'id'                => '1472041816898',
		 ...
		 *
		 * @link https://www.trustpayments.com//doc/api/webhook-entity/view/1472041839405
		 */
		[
			'id'                => '1472041839405',
		 ...
		 *
		 * @link https://www.trustpayments.com//doc/api/webhook-entity/view/1472041857405
		 */
		[
			'id'                => '1472041857405',
	 ...
	 *
	 * @return \TrustPaymentsPayment\Core\Api\WebHooks\Service\WebHooksService
	 */
	...
	protected function installListeners(): array
	{
		...
		try {
			...
			/**
			 * @var \TrustPaymentsPayment\Core\Api\WebHooks\Struct\Entity $data
			 */
	...
	protected function getWebHookCallBackUrl(): string
	{
		return $this->router->generate(
			'api.action.trustpayments.webhook.update',
