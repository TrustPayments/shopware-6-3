...
namespace TrustPaymentsPayment\Core\Settings\Struct;
 ...
 * Class Settings
 *
 * @package TrustPaymentsPayment\Core\Settings\Struct
 */
class Settings extends Struct {
	...
	public function getApiClient(): ApiClient
	{
		if (is_null($this->apiClient)) {
			...
			$apiClientBasePath = getenv('TRUSTPAYMENTS_API_BASE_PATH') ? getenv('TRUSTPAYMENTS_API_BASE_PATH') : $this->apiClient->getBasePath();
