...
namespace TrustPaymentsPayment\Core\Settings\Service;

use Psr\Log\LoggerInterface;
use Shopware\Core\System\SystemConfig\SystemConfigService;
use TrustPaymentsPayment\Core\Settings\Struct\Settings;


/**
 * Class SettingsService
 *
 * @package TrustPaymentsPayment\Core\Settings\Service
 */
class SettingsService {

	/**
	 * Prefix to TrustPayments configs
	 */
	public const SYSTEM_CONFIG_DOMAIN                       = 'TrustPaymentsPayment.config.';
	 ...
	 *
	 * @param string|null $salesChannelId
	 * @return \TrustPaymentsPayment\Core\Settings\Struct\Settings|null
	 */
	 ...
	 *
	 * @param string|null $salesChannelId
	 * @return \TrustPaymentsPayment\Core\Settings\Struct\Settings
	 */
