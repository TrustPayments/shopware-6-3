...
namespace TrustPaymentsPayment\Core\Settings\Command;
 ...
 * @internal
 * @package TrustPaymentsPayment\Core\Settings\Command
 */
class SettingsCommand extends Command {
	 ...
	 * @var string
	 */
	protected static $defaultName = 'trustpayments:settings:install';
	...
	{
		$output->writeln('Set TrustPaymentsPayment settings...');
	...
	{
		$this->setDescription('Sets TrustPaymentsPayment settings.')
			 ->setHelp('This command updates TrustPaymentsPayment settings for all SalesChannels.')
			 ->addOption(
