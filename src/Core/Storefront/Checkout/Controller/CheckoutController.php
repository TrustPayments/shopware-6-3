...
namespace TrustPaymentsPayment\Core\Storefront\Checkout\Controller;
 ...
 *
 * @package TrustPaymentsPayment\Core\Storefront\Checkout\Controller
 *
...
class CheckoutController extends StorefrontController {
	 ...
	 *
	 * @Route(
	 *     "/trustpayments/checkout/pay",
	 *     name="frontend.trustpayments.checkout.pay",
	 *     options={"seo": "false"},
	 *     methods={"GET"}
	 *     )
	 */
	public function pay(SalesChannelContext $salesChannelContext, Request $request): Response
	{
		...
		if (empty($possiblePaymentMethods)) {
			$this->addFlash('danger', $this->trans('trustpayments.paymentMethod.notAvailable'));
		...
		$page->addExtension('trustPaymentsData', $checkoutPageData);

		return $this->renderStorefront(
			'@TrustPaymentsPayment/storefront/page/checkout/order/trustpayments.html.twig',
			['page' => $page]
		);
	}
	 ...
	 *
	 * @Route(
	 *     "/trustpayments/checkout/recreate-cart",
	 *     name="frontend.trustpayments.checkout.recreate-cart",
	 *     options={"seo": "false"},
	 *     methods={"GET"}
	 *     )
	 */
