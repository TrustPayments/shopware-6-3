...
/**
 * @class TrustPaymentsPayment\Core\Api\Transaction\Controller\TransactionController
 */
class TrustPaymentsTransactionService extends ApiService {

	/**
	 * TrustPaymentsTransactionService constructor
	 *
	 * @param httpClient
	 * @param loginService
	 * @param apiEndpoint
...
export default TrustPaymentsTransactionService;